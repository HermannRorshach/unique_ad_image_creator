...
class CropImage:
    ...
    def generate_combinations(self):
        ...
        valid_combinations = [', '.join(combo) for combo in all_combinations if combo.count('crop_normal') <= 2]
...
patterns = {1: {'adjust_white_balance': (),
 ...
 47: {'adjust_white_balance': (0.95, 1.05, 1.0),
      ...
      'resize_image': (),
      'rotate_image': ()},
 48: {'adjust_white_balance': (),
      'adjust_contrast': (),
      'adjust_brightness': (),
      'crop_image_by_percentage': (),
      'resize_image': (),
      'rotate_image': ('right', 1)},
 49: {'adjust_white_balance': (),
      'adjust_contrast': (),
      'adjust_brightness': (),
      'crop_image_by_percentage': (),
      'resize_image': (),
